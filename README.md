# LLD & HLD Practice
This repository contains a collection of Low-Level Design (LLD) and High-Level Design (HLD) exercises and mental models.
...
- [Distributed Job Scheduler](./distributed-job/README.md)
